...
function checkMail2Inscription() {
    ...
    if (document.formInscription.mail2.value != document.formInscription.mail.value || document.formInscription.mail2.value == "" || !reg.test(document.formInscription.mail2.value)) {
        document.getElementById("checkMail2").innerHTML = "<img src='templates/images/check-rouge.png'>";
    }
    else {
        document.getElementById("checkMail2").innerHTML = "<img src='templates/images/check-vert.png'>";
    }
}
...
function checkPasswordInscription() {
    if (document.formInscription.password.value == "" || document.formInscription.password.value.length < 6) {
        document.getElementById("checkPassword").innerHTML = "<img src='templates/images/check-rouge.png'>";
    }
    else {
        document.getElementById("checkPassword").innerHTML = "<img src='templates/images/check-vert.png'>";
    }
}
...
function checkPassword2Inscription() {
    if (document.formInscription.password2.value != document.formInscription.password.value || document.formInscription.password2.value == "") {
        document.getElementById("checkPassword2").innerHTML = "<img src='templates/images/check-rouge.png'>";
    }
    else {
        document.getElementById("checkPassword2").innerHTML = "<img src='templates/images/check-vert.png'>";
    }
}
...
function checkBirthday() {
    if (document.formInscription.birthday.value == "" || document.formInscription.birthmonth.value == "" || document.formInscription.birthyear.value == "") {
        document.getElementById("checkBirthday").innerHTML = "<img src='templates/images/check-rouge.png'>";
    }
    else {
        document.getElementById("checkBirthday").innerHTML = "<img src='templates/images/check-vert.png'>";
    } 
}

function checkPseudo() {
    if(document.formInscription.pseudo.value.length < 3) {
        document.getElementById("checkPseudo").innerHTML = "<img src='templates/images/check-rouge.png'>";
    }
    else {
        document.getElementById("checkPseudo").innerHTML = "<img src='templates/images/check-vert.png'>";
    }
}
...
function checkInscription() {
    ...
    var rouge = "<img src=\"templates/images/check-rouge.png\">";
